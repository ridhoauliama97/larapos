                                                ...
                                                <div className="flex gap-2">
                                                    {canUpdateRoles && (
                                                        <button
                                                            ...
                                                            className="inline-flex items-center justify-center gap-2 font-medium transition-all duration-200 active:scale-[0.98] px-3 py-2 rounded-xl border bg-warning-100 border-warning-200 text-warning-600 hover:bg-warning-200 dark:bg-warning-900/50 dark:border-warning-800 dark:text-warning-400"
                                                        >
                                                            <IconPencilCog
                                                                size={16}
                                                                strokeWidth={
                                                    ...
                                                    {canDeleteRoles && (
                                                        <button
                                                            ...
                                                            className="inline-flex items-center justify-center gap-2 font-medium transition-all duration-200 active:scale-[0.98] px-3 py-2 rounded-xl border bg-danger-100 border-danger-200 text-danger-600 hover:bg-danger-200 dark:bg-danger-900/50 dark:border-danger-800 dark:text-danger-400"
                                                        >
                                                            <IconTrash
                                                                size={16}
                                                                strokeWidth={
