            ...
            <div className="space-y-6">
                ...
                {rows.length > 0 ? (
                    <div
                        ...
                        className="rounded-2xl border-0 bg-transparent shadow-none sm:overflow-hidden sm:border sm:border-slate-200 sm:bg-white sm:dark:border-slate-800 sm:dark:bg-slate-900"
                    >
