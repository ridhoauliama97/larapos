...
const statusBadge = (status) => {
    ...
    return (
        <span
            className={`inline-flex rounded-full px-3 py-1.5 text-sm font-semibold ${styles[status] || styles.draft}`}
        >
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                                ...
                                <div className="mt-4 space-y-3">
                                    {can('stock-transfers-send') && (
                                        <button
                                            onClick={() => confirmAction('send', 'mengirim')}
                                            className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary-500 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-primary-600"
                                        >
                                    ...
                                    {can('stock-transfers-cancel') && (
                                        <button
                                            onClick={() => confirmAction('cancel', 'membatalkan')}
                                            className="flex w-full items-center justify-center gap-2 rounded-xl border border-rose-200 px-4 py-2.5 text-sm font-medium text-rose-600 transition-colors hover:bg-rose-50 dark:border-rose-900 dark:text-rose-400 dark:hover:bg-rose-950/20"
                                        >
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                                ...
                                <div className="mt-4 space-y-3">
                                    {can('stock-transfers-receive') && (
                                        <button
                                            onClick={() => confirmAction('receive', 'menerima')}
                                            className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-500 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-emerald-600"
                                        >
