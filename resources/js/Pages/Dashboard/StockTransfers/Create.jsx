...
export default function Create({ warehouses, products }) {
    ...
    const warehousesExcept = (excludeId) =>
        warehouses.filter((w) => String(w.id) !== String(excludeId));
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                            <div>
                                ...
                                <Select
                                    ...
                                    onChange={(value) =>
                                        setData({ ...data, source_warehouse_id: value })
                                    }
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    onChange={(value) =>
                                        setData({ ...data, destination_warehouse_id: value })
                                    }
                                    options={warehousesExcept(data.source_warehouse_id).map(
                        ...
                        {data.items.length > 0 ? (
                            ...
                            <div className="rounded-xl border border-dashed border-slate-200 p-8 text-center dark:border-slate-700">
                                ...
                                <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                                    Cari produk di atas untuk ditambahkan ke transfer.
                                </p>
                            </div>
                        )}
                    </div>
