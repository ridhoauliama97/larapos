...
const setupCommands = `git clone https://github.com/ridhoauliama97/larapos
cd point-of-sales
cp .env.example .env
        ...
        <PublicLayout active="/kontribusi">
            ...
            <section className="pt-20 pb-14 px-6 bg-gradient-to-b from-primary-50 dark:from-primary-950/40 to-transparent">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white">
                        Bantu Larapos Tumbuh
                    </h1>
                    <p className="mt-5 text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                        Open source hidup dari kontributor — laporan bug,
                        perbaikan kode, dokumentasi, atau sekadar ide. Semua
                        disambut!
                    </p>
                </div>
            </section>
            ...
            <section className="pb-16 px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-700">
                        <table className="w-full text-sm">
                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                <tr>
                                    <td className="px-5 py-3 font-mono text-primary-600 dark:text-primary-400">
                                        main
                                    </td>
                                    <td className="px-5 py-3 text-slate-600 dark:text-slate-400">
                                        Production. Hanya dari merge release
                                    </td>
                                </tr>
                                <tr>
                                    <td className="px-5 py-3 font-mono text-primary-600 dark:text-primary-400">
                                    ...
                                    <td className="px-5 py-3 text-slate-600 dark:text-slate-400">
                                        Integrasi. Semua feature branch merge ke
                                        sini
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="px-5 py-3 text-slate-600 dark:text-slate-400">
                                        Kerja fitur baru. Branch dari
                                        development, PR ke development
                                    </td>
                                </tr>
                                <tr>
                                    <td className="px-5 py-3 font-mono text-primary-600 dark:text-primary-400">
                                    ...
                                    <td className="px-5 py-3 text-slate-600 dark:text-slate-400">
                                        Hotfix. Branch dari main, PR ke main +
                                        development
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="px-5 py-3 text-slate-600 dark:text-slate-400">
                                        Release candidate. Dari development,
                                        merge ke main + tag
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div className="mt-6 rounded-xl bg-slate-100 dark:bg-slate-800/60 px-5 py-4 text-sm font-mono text-slate-600 dark:text-slate-300 text-center">
                        feature/nama-fitur → development → release/x.y.z → main
                        (tag vX.Y.Z)
                    </div>
                </div>
            </section>
            ...
            <section className="pb-16 px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="mt-4 text-sm text-slate-500 dark:text-slate-400">
                        ...
                        . Akun default:{" "}
                        <code className="font-mono">arya@gmail.com</code>{" "}
                        (admin) dan{" "}
                        <code className="font-mono">cashier@gmail.com</code>{" "}
                        (kasir), password:{" "}
            ...
            <section className="pb-16 px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="p-5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                            ...
                            <p className="text-sm text-slate-600 dark:text-slate-400">
                                Test otomatis berjalan di SQLite in-memory —
                                tidak butuh MySQL untuk mengetes.
                            </p>
                        </div>
                        <div className="p-5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                            <div className="font-mono text-sm text-primary-600 dark:text-primary-400 mb-1">
                    ...
                    <p className="mt-4 text-sm text-slate-500 dark:text-slate-400">
                        💡 Saat menulis test produk, set{" "}
                        <code className="font-mono">tax_rate=0</code> agar
